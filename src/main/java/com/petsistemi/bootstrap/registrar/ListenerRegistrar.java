...
public final class ListenerRegistrar {
    ...
    public static void register(PetPluginContext context) {
        Bukkit.getPluginManager().registerEvents(new PetMenuListener(context.plugin(), context.operationService(), context.petService(), context.sessionManager(), context.definitionRegistry(), context.mainThreadDispatcher(), context.messageService(), context.configSnapshot()), context.plugin());
        ...
        Bukkit.getPluginManager().registerEvents(new PetProtectionListener(context.activePetRegistry(), context.petService(), context.plugin(), context.definitionRegistry(), context.configSnapshot(), context.messageService(), context.hitboxController()), context.plugin());
