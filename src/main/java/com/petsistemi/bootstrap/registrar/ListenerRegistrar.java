...
public final class ListenerRegistrar {
    ...
    public static void register(PetPluginContext context) {
        ...
        Bukkit.getPluginManager().registerEvents(new PetProtectionListener(context.activePetRegistry(), context.petService(), context.plugin(), context.definitionRegistry(), context.configSnapshot(), context.messageService()), context.plugin());
